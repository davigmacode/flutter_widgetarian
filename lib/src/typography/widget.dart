...
enum TypographySize { small, medium, large }
...
class DisplayText extends Typography {
  const DisplayText(
    super.data, {
    super.key,
    super.style,
...
class HeadlineText extends Typography {
  const HeadlineText(
    super.data, {
    super.key,
    super.style,
...
class BodyText extends Typography {
  const BodyText(
    super.data, {
    super.key,
    super.style,
...
class LabelText extends Typography {
  const LabelText(
    super.data, {
    super.key,
    super.style,
...
class TitleText extends Typography {
  const TitleText(
    super.data, {
    super.key,
    super.style,
